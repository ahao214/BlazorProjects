...
namespace Joker.LearnBlazor.Web.Repository
{
    public class ProductRepository : IProduct
    {
        ...
        public ProductRepository()
        {
            ...
            {
                new Product(){ ProductId=1,ProductName="抽纸",ThumbnailImage="1.jpg"},
                new Product(){ ProductId=2,ProductName="牛奶",ThumbnailImage="2.jpg"},
                new Product(){ ProductId=3,ProductName="蛋糕",ThumbnailImage="3.jpg"},
